...
export default function About() {
    ...
    <section id="about">
        <div id='splitImage'>
            <p class="heading1">
                ! My name is Zahabiyah and I am currently a rising Sophomore at the University Of Wisconsin Madison studying Computer Science and Mathematics. I am interested in technology and seeking ways we can use it to transform various social issues. 
            </p>
            <div class='layer'>
